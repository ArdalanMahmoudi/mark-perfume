...
import { Mail, Map, Pencil, Phone, User } from "lucide-react";
        ...
        <Container>
          <div className="my-8 grid grid-cols-10 gap-8">
            ...
            <div className="lg:col-span-7 col-span-10">
              <div
                className="w-full h-full bg-secondary-layout bg-cover rounded-tr-[160px]!  min-h-100"
          ...
          <div className="my-12 grid grid-cols-10 gap-8">
            ...
            <div className="bg-secondary-layout rounded-t-full! rounded-b-lg! lg:col-span-3 col-span-10">
              ...
              <form className="flex mt-4 lg:mt-10  w-full px-2 flex-col items-center">
                <InputGroupInlineStart
                  classNameLabel="h-0"
                  classNameField="h-fit bg-white"
                  element="input"
                ...
                <InputGroupInlineStart
                  classNameLabel="h-0"
                  classNameField="h-fit "
                  element="textarea"
                  placeholder="متن پیام"
                />
                <Button className="w-fit px-12 py-2" variant={"default"}>
                  ارسال
                </Button>
              </form>
            </div>
